...
public class Entry {
	...
	private String link;
	@Element(name = "mobile_link", required = false)
	private Link mobile_link;
	...
	@Element(name = "stock_quantity", required = false)
	...
	public Link getMobile_link() {
		return mobile_link;
	}

	public void setMobile_link(Link mobile_link) {
