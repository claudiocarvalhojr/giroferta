		...
		<table class="table table-striped table-hover table-responsive">
			<thead>
				<tr>
					...
					<th style="width: 15%"><a href="${linkAdminReportByAdv}?type_report=gross"><fmt:message key="report.advertisement.column.gross_click" /></a></th>
					<th style="width: 10%"><a href="${linkAdminReportByAdv}?type_report=count"><fmt:message key="report.advertisement.column.count_click" /></a></th>
					<th style="width: 15%"><a href="${linkAdminReportByAdv}?type_report=purchase"><fmt:message key="report.advertisement.column.purchases" /></a></th>
