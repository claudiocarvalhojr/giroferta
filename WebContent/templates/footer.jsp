...
<div class="footer-site">
	...
	<br />
	<br />
	<a href="http://www.facebook.com.br/girofertaoficial" target="_blank">
		<img alt="Facebook" src="${giroUrl }/resources/images/ico-facebook.png">
	</a>
	<a href="http://www.instagram.com/giroferta" target="_blank">
		<img alt="Instagram" src="${giroUrl }/resources/images/ico-instagram.png">
	</a>
	<a href="http://www.twitter.com/giroferta" target="_blank">
